...
call npm install @langchain/anthropic@^0.3.7 @langchain/community@^0.3.15 @langchain/core@^0.3.21 @langchain/google-genai@^0.1.3 @langchain/openai@^0.3.12 langchain@^0.3.6 uuid@^11.0.3

REM Install dev dependencies
echo 📦 Installing development dependencies...
call npm install --save-dev @types/uuid@^10.0.0
